...
**Model:** `ornekler\hatali_ornek.ifc` · **Şema:** IFC4X3 · **Tarih:** 17.09.2026 14:20  
...
**Özet:** 19 hata, 5 uyarı, 5 elle kontrol.
...
| 9 | Genel | IFC Sınıfları | Yönetmeliğin 13 üncü maddesinde belirtilen projedeki mevcut "Zorunlu IFC Sınıfları" için zorunlu öznitelikler ve özellikler tanımlandı mı? | Hayır | HATA: IfcColumn: 1 varlığa malzeme atanmamış (IfcRelAssociatesMaterial).<br>HATA: IfcColumn: Pset_ColumnCommon.FireRating (Yangın Dayanım Sınıfı) 1 varlıkta yok ya da boş.<br>HATA: IfcColumn: Pset_ColumnCommon.LoadBearing (Taşıyıcı) 1 varlıkta yok ya da boş.<br>HATA: IfcSpace: Pset_SpaceCoveringRequirements.FloorCovering (Zemin Kaplaması) 2 varlıkta yok ya da boş.<br>HATA: IfcSpace: Pset_SpaceCoveringRequirements.FloorCoveringThickness (Zemin Kaplama Kalınlığı) 2 varlıkta yok ya da boş.<br>HATA: IfcSpace: Pset_SpaceCoveringRequirements.WallCovering (Duvar Kaplaması) 2 varlıkta yok ya da boş.<br>HATA: IfcSpace: Pset_SpaceCoveringRequirements.WallCoveringThickness (Duvar Kaplama Kalınlığı) 2 varlıkta yok ya da boş.<br>HATA: IfcSpace: Pset_SpaceCoveringRequirements.CeilingCovering (Tavan Kaplaması) 2 varlıkta yok ya da boş.<br>HATA: IfcSpace: Pset_SpaceCoveringRequirements.CeilingCoveringThickness (Tavan Kaplama Kalınlığı) 2 varlıkta yok ya da boş.<br>HATA: IfcWall: Pset_WallCommon.IsExternal (Dışarıda) 1 varlıkta yok ya da boş.<br>HATA: IfcWall: Pset_WallCommon.FireRating (Yangın Dayanım Sınıfı) 1 varlıkta yok ya da boş. |
...
| 15 | Genel | Varlıklar | Varlıklar doğru katta veya doğru kotta modellendi mi? | Hayır | HATA: 1 yapı elemanı hiçbir bina katına bağlı değil (IfcRelContainedInSpatialStructure). Her eleman bir kata atanmalı.<br>UYARI: 1 eleman bağlı olduğu katın kot aralığının dışında (kat kotunun 1.5 m altı ile üst katın 1.5 m üstü dışında); yanlış kata atanmış ya da yanlış kota çizilmiş olabilir. |
...
- **HATA** [m.10, EK-3 Tablo 3.1, EK-2 Tablo 2.14] (EK-9 m.4): 1 mahalin numarası EK-3 şablonuna uymuyor. Beklenen Kat_Bölüm_SıraNo, alt tire ile: kat kodu B01/B02… (bodrum), K00 (zemin), K01… ya da NNN; bölüm üç karakter; sıra no üç basamak — örn. K00_DAI_001.
  - varlıklar: `2ry5VgU9T5181nicv$j1Zx`
...
- **HATA** [EK-6 Tablo 6.16] (EK-9 m.9): IfcColumn: 1 varlığa malzeme atanmamış (IfcRelAssociatesMaterial).
  - varlıklar: `3DfiwzxWXC8gZKEHzwulT6`
...
- **HATA** [EK-6 Tablo 6.16] (EK-9 m.9): IfcColumn: Pset_ColumnCommon.LoadBearing (Taşıyıcı) 1 varlıkta yok ya da boş.
  - varlıklar: `3DfiwzxWXC8gZKEHzwulT6`
- **HATA** [EK-6 Tablo 6.58] (EK-9 m.9): IfcSpace: Pset_SpaceCoveringRequirements.FloorCovering (Zemin Kaplaması) 2 varlıkta yok ya da boş.
  - varlıklar: `0RxZaZbZbD1ea3oSBZJ9CQ`, `2ry5VgU9T5181nicv$j1Zx`
- **HATA** [EK-6 Tablo 6.58] (EK-9 m.9): IfcSpace: Pset_SpaceCoveringRequirements.FloorCoveringThickness (Zemin Kaplama Kalınlığı) 2 varlıkta yok ya da boş.
  - varlıklar: `0RxZaZbZbD1ea3oSBZJ9CQ`, `2ry5VgU9T5181nicv$j1Zx`
- **HATA** [EK-6 Tablo 6.58] (EK-9 m.9): IfcSpace: Pset_SpaceCoveringRequirements.WallCovering (Duvar Kaplaması) 2 varlıkta yok ya da boş.
  - varlıklar: `0RxZaZbZbD1ea3oSBZJ9CQ`, `2ry5VgU9T5181nicv$j1Zx`
- **HATA** [EK-6 Tablo 6.58] (EK-9 m.9): IfcSpace: Pset_SpaceCoveringRequirements.WallCoveringThickness (Duvar Kaplama Kalınlığı) 2 varlıkta yok ya da boş.
  - varlıklar: `0RxZaZbZbD1ea3oSBZJ9CQ`, `2ry5VgU9T5181nicv$j1Zx`
- **HATA** [EK-6 Tablo 6.58] (EK-9 m.9): IfcSpace: Pset_SpaceCoveringRequirements.CeilingCovering (Tavan Kaplaması) 2 varlıkta yok ya da boş.
  - varlıklar: `0RxZaZbZbD1ea3oSBZJ9CQ`, `2ry5VgU9T5181nicv$j1Zx`
- **HATA** [EK-6 Tablo 6.58] (EK-9 m.9): IfcSpace: Pset_SpaceCoveringRequirements.CeilingCoveringThickness (Tavan Kaplama Kalınlığı) 2 varlıkta yok ya da boş.
  - varlıklar: `0RxZaZbZbD1ea3oSBZJ9CQ`, `2ry5VgU9T5181nicv$j1Zx`
...
- **UYARI** [EK-9 madde 13]: 1 mahal çifti aynı katta birbirine giriyor (sınır kutuları küçük hacmin %10'undan fazla örtüşüyor); sınırları düzeltin. Kutu tabanlı kaba kontroldür, L biçimli mahallerde yanlış alarm verebilir.
  - varlıklar: `1s14XbTDT2hx6VwpAGaJc5`, `0RxZaZbZbD1ea3oSBZJ9CQ`
...
- **HATA** [EK-9 madde 15]: 1 yapı elemanı hiçbir bina katına bağlı değil (IfcRelContainedInSpatialStructure). Her eleman bir kata atanmalı.
  - varlıklar: `3DfiwzxWXC8gZKEHzwulT6`
- **UYARI** [EK-9 madde 15]: 1 eleman bağlı olduğu katın kot aralığının dışında (kat kotunun 1.5 m altı ile üst katın 1.5 m üstü dışında); yanlış kata atanmış ya da yanlış kota çizilmiş olabilir.
  - varlıklar: `0W_6WHn8LF0On_$zW3qkHA`
- **UYARI** [EK-9 madde 16]: 1 yerde aynı sınıf, isim ve yerleşimle birden fazla eleman var; üst üste kopyalanmış olabilir.
  - varlıklar: `1bNK4mPmjFZvre$pqLr$K6`, `2wfP_tfT95e9ca9BWJCsST`
...
- **UYARI** [EK-9 madde 19, EK-6]: 2 elemanda Ön Tanımlı Tip boş ya da NOTDEFINED; tipi seçin (IfcWall için SOLIDWALL/PARTITIONING…, IfcSlab için FLOOR/ROOF…).
  - varlıklar: `1hTeNg1jT0NuFTQmSyXLTP`, `1KobZ$9qH4TfqjsEui6MDY`
